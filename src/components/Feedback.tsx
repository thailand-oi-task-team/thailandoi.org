...
const FeedbackThanks = forwardRef<React.ElementRef<'div'>>(
  function FeedbackThanks(_props, ref) {
    return (
      ...
      >
        <div className="flex items-center gap-3 rounded-full bg-purple-50/50 py-1 pl-1.5 pr-3 text-sm text-purple-900 ring-1 ring-inset ring-purple-500/20 dark:bg-purple-500/5 dark:text-purple-200 dark:ring-purple-500/30">
